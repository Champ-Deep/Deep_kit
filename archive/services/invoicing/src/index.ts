...
import { initDatabase, pool } from './services/database';
...
const app = express();
const PORT = parseInt(process.env.PORT || '7715', 10);

// Event Bus
export const eventBus = new DeepKitEventBus('invoicing');
...
async function start() {
  try {
    ...
    app.listen(PORT, '0.0.0.0', () => {
      console.log(`💰 Invoice & Billing running on port ${PORT}`);
