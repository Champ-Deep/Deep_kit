...
import linkRoutes, { redirectRoute } from './routes/link-routes';
...
// Event Bus
export const eventBus = new DeepKitEventBus('link-shortener');
...
// Redirect route (short URLs)
app.get('/s/:shortCode', redirectRoute);
