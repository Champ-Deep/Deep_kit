      ...
      <Card variant="card" width="full">
        ...
        <div className="px-4 py-3">
          <div className="flex items-center justify-between mb-3">
            <Tag text={execution.status.toUpperCase()} variant={statusVariant} size="md" />
      ...
      <Card variant="card" width="full">
        ...
        <div className="px-2">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead style={{ color: '#A0A0A0', fontSize: '11px', letterSpacing: '0.1em' }}>NAME</TableHead>
                <TableHead style={{ color: '#A0A0A0', fontSize: '11px', letterSpacing: '0.1em', textAlign: 'right' }}>STATUS</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {workflows.map((wf) => (
